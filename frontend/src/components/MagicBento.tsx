...
export function createParticleElement(x: number, y: number, color = "76, 139, 245") {
...
export const GlobalSpotlight: React.FC<{
	...
	glowColor?: string;
}> = ({ gridRef, disableAnimations = false, enabled = true, spotlightRadius = DEFAULT_SPOTLIGHT_RADIUS, glowColor = "76, 139, 245" }) => {
...
const DEFAULT_ITEMS: BentoItem[] = [
	{ color: "#0D0716", title: "Analytics", description: "Track user behavior", label: "Insights" },
	{ color: "#170D27", title: "Dashboard", description: "Centralized data view", label: "Overview" },
	{ color: "#271E37", title: "Collaboration", description: "Work together seamlessly", label: "Teamwork" },
	{ color: "#0D0716", title: "Automation", description: "Streamline workflows", label: "Efficiency" },
	{ color: "#170D27", title: "Integration", description: "Connect favorite tools", label: "Connectivity" },
	{ color: "#271E37", title: "Security", description: "Enterprise-grade protection", label: "Protection" },
];
		...
		<>
			...
			<div className="card-grid bento-section" ref={gridRef}>
				{items.map((card, index) => {
					...
					const commonStyle: React.CSSProperties = { backgroundColor: card.color as string, ["--glow-color" as any]: glowColor };
					if (enableStars) {
						return (
							<ParticleCard
								key={index}
					...
					return (
						<div key={index} className={baseClassName} style={commonStyle}>
							<div className="magic-bento-card__header">
								<div className="magic-bento-card__label">{card.label}</div>
							</div>
							<div className="magic-bento-card__content">
